class Player {
    ...
    resize() {
        this.width = this.spriteWidth * this.game.radio;
        this.height = this.spriteHeight * this.game.radio;
        this.y = this.game.height * 0.5 - this.height * 0.5;
        this.speedY = -8 * this.game.radio;
        this.flapSpeed = 5 * this.game.radio;
        this.collisionRadius = 40 * this.game.radio;
        this.collisionX = this.x + this.width * 0.5;
        this.collided = false;
        this.barSize = Math.floor(5 * this.game.radio);
        this.frameY = 0;
        this.charging = false;
    }
